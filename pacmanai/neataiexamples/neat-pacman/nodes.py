...
class Node(object):
    def __init__(self, x, y):
        ...
        self.dist = 0
        self.neighbors:dict[int,Union[Node,None]] = {UP:None, DOWN:None, LEFT:None, RIGHT:None,PORTAL:None}
...
class NodeGroup(object):
    ...
    def setInersections(self):
        for key,value in self.nodesLUT.items():
            count = 0
            for c,v in enumerate(value.neighbors):
                if v:
                    count += 1
            if count >= 3:
                value.isIntersection = True
